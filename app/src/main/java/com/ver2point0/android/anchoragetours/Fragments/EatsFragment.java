...
import com.ver2point0.android.anchoragetours.Models.Eats;
...
public class EatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        List<Location> eatsListFragment = new ArrayList<>();
        Eats.eatsList(eatsListFragment, getContext());

        LocationAdapter locationAdapter = new LocationAdapter(getActivity(), -1, eatsListFragment);
